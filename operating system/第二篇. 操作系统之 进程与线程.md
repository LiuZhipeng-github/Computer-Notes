...
![屏幕截图 2020-09-23 180446](/Users/liuzhipeng/Downloads/Notes-of-operating-systems/操作系统.assets/屏幕截图 2020-09-23 180446-1601000647171.png)
...
![屏幕截图 2020-09-23 211204](/Users/liuzhipeng/Downloads/Notes-of-operating-systems/操作系统.assets/屏幕截图 2020-09-23 211204.png)
...
![FF17BBFA-76C8-4E05-B83B-FA8D15787E58_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/FF17BBFA-76C8-4E05-B83B-FA8D15787E58_1_105_c.jpeg)
...
- 进程是一个拥有资源的独立单元；
- 进程同时又是一个可以被处理器独立调度和分配的单元。为了使多个程序更好地并发执行，并尽量减少操作系统的开销，操作系统设计者引入了线程，让线程去完成第二个基本属性的任务，而进程只完成第一个基本属性的任务。
...
- **用户级线程切换例子：**
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/2019081814121333.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
  关键：两个TCB+两个栈
  Yield()就是切换esp，也就是栈顶指针，即切换了栈
  Yield()之后通过栈的弹出继续另一个线程的执行

- **线程的创建：**
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/2019081814194175.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
  步骤：
  1、申请内存作为TCB
  2、申请内存作为栈
  3、在栈里面压入起始地址

  ![8C0CC2E0-322D-4184-9CAC-53CDEB631B29_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/8C0CC2E0-322D-4184-9CAC-53CDEB631B29_1_105_c.jpeg)
...
![DA198760-1088-448D-BB00-740876362B0E_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/DA198760-1088-448D-BB00-740876362B0E_1_105_c.jpeg)
...
- **用户栈与内核栈之间的关联**
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818143353708.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
  1、对于栈顶的段地址，其是存放在段寄存器 SS 中的，而对于栈顶的偏移地址，其则是存放在 SP 寄存器中的 。在任何时刻，SS:SP 都是指向栈顶元素 。ss，sp将内核栈与用户栈相连，
  2、CS，code segment，存放段基址的寄存器

  如何从用户到内核：中断
  举个例子：
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818153328944.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)

- 内核级线程的切换：
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818153635865.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
...
![13237CC5-EF78-4AA2-978B-E9470B31AF89_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/13237CC5-EF78-4AA2-978B-E9470B31AF89_1_105_c.jpeg)

**这里要注意，中断出口这里已经经过了前面的switch_to,中断的iret已经不是原先的中断返回了，是切换后的新中断的执行返回！！！这样返回以后就来到了引发该新中断的用户态代码来执行**

![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818135331626.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
...
- ![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818154421347.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
  

#### 3.用户级线程 vs 核心级线程

![在这里插入图片描述](https://img-blog.csdnimg.cn/20190818154600627.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTc2MTQ3OA==,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190120230136364.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MjE3NDM0Mg==,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190120231210825.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MjE3NDM0Mg==,size_16,color_FFFFFF,t_70)
...
![2AF8A375-A169-44E2-8139-B95D0DEB865C_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/2AF8A375-A169-44E2-8139-B95D0DEB865C_1_105_c.jpeg)
...
![9AEEF68F-06B5-43D7-897E-212212177542_1_105_c](/Users/liuzhipeng/Downloads/学习/操作系统/pic/9AEEF68F-06B5-43D7-897E-212212177542_1_105_c.jpeg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200415203108112.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NjbnVhY21oZHU=,size_16,color_FFFFFF,t_70)

### 死锁的四个必要条件

![在这里插入图片描述](https://img-blog.csdnimg.cn/20200415203152939.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NjbnVhY21oZHU=,size_16,color_FFFFFF,t_70)

### 银行家算法

用来死锁避免。
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200415204239465.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NjbnVhY21oZHU=,size_16,color_FFFFFF,t_70)
